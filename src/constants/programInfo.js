...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to help students build a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const threeStepCardText = {
	...
	step2: {
		...
		text:
			'Choose between the Full-Time Coding Bootcamp, Hybrid Coding Bootcamp, and In-Person JavaScript Bootcamp programs.'
	},
